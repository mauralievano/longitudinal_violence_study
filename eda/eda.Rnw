...
SCM_nodes <- c("victim1", "victim2", "victim3", "victim4", "suicide1", 
               ...
               "psywell2", "psywell3", "psywell4", "psywell5", "victfrnd1", 
               "victfrnd2", "victfrnd3", "victfrnd4", "drug1", "drug2", "drug3", 
               "drug4", "drug5", "alcohol1", "alcohol2", "alcohol3", "alcohol4", 
               "alcohol5", "dating2", "dating3", "dating4", "dating5")
