...
# make table of summary stats for each var 
# dount the total number, number in the treatment and not 
# get true psi by deterministically setting treatment and no treatment at each time point 
#  dist. of estimates from bootstrap