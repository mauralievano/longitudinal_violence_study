...
female_SCM_copy <- female_SCM[, 7:43]
colnames(female_SCM_copy) <- c("L1_1", "L2_1", "L3_1", "L7_1", "L4_1", "L5_1", "L6_1","C1", 
                               "A1", "L1_2", "L2_2", "L3_2", "L7_2", "L4_2", "L5_2", "L6_2","C2", 
                               "A2", "L1_3", "L2_3", "L3_3", "L7_3", "L4_3", "L5_3", "L6_3","C3", 
                               "A3", "L1_4", "L2_4", "L3_4", "L7_4", "L4_4", "L5_4", "L6_4","C4",
                               "A4", "Y")

# Fit models fo suicide L1 at each time point 
L1_2_lm <- glm(L1_2~L1_1 + L2_1+L3_1+L7_1+L4_1+L5_1+L6_1+C1+A1, data = female_SCM_copy)
L1_3_lm <- glm(L1_3~L1_1+L2_1+L3_1+L7_1+L4_1+L5_1+L6_1+C1+A1+L1_2+L2_2+L3_2+L7_2+L4_2+L5_2+L6_2+C2+A2, data = female_SCM_copy)
L1_4_lm <- glm(L1_4~L1_1+L2_1+L3_1+L7_1+L4_1+L5_1+L6_1+C1+A1+L1_2+L2_2+L3_2+L7_2+L4_2+L5_2+L6_2+C2+A2+L1_3+L2_3+L3_3+L7_3+L4_3+L5_3+L6_3+C3+A3, data = female_SCM_copy)
```
...
generate_data_intervene <- function(n) {
 ...
 df <- data.frame( # Intervention node: prob based on the mean of victim in that year
                   ...
                   L2_1 = rbinom(n, 1, prob = 0.25),
                   L2_2 = rbinom(n, 1, prob = 0.5),
                   L2_3 = rbinom(n, 1, prob = 0.5),
                   L2_4 = rbinom(n, 1, prob = 0.5),
                   ...
                   L6_4 = rbinom(n, 1, prob = 0.75),
                   
                   # Psychological well being: based on mean of psywell in that year 
                   L7_1 = rnorm(n, 3.2, 0.8),
                   L7_2 = rnorm(n, 3.2, 0.8),
                   L7_3 = rnorm(n, 3.5, 0.8),
                   L7_4 = rnorm(n, 3.6, 0.6),
...
df <- df %>%
  mutate(L1_2 = ifelse(predict(L1_2_lm, newdata = df) > 0.5, 1, 0),
           L1_3 = ifelse(predict(L1_3_lm, newdata = df) > 0.5, 1, 0), 
           L1_4 = ifelse(predict(L1_4_lm, newdata = df) > 0.5, 1, 0))
...
# Order for ltmle
df <- df %>%
  select(L1_1, L2_1, L3_1, L4_1, L5_1, L6_1, L7_1, C1, A1, 
         L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, C2, A2,    
         L1_3, L2_3, L3_3, L4_3, L5_3, L6_3, L7_3, C3, A3,
         L1_4, L2_4, L3_4, L4_4, L5_4, L6_4, L7_4, C4, A4, 
         Y)
...
Lnodes <-  c("L1_1","L2_1","L3_1","L4_1", "L5_1", "L6_1", "L7_1",
...
data.frame("Estimator" = c("G-Comp", "IPTW", "TMLE"),
           "Estimate" = c("-0.012483", "-0.16065", "-0.019438"),
           "95% CI" = c("(-0.1216, 0.096635)", "(-0.37914, 0.057846)", "(-0.12825, 0.089371) "))
```
